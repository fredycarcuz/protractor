describe('CCIU', function() {
  ...
  it('Should open and fill the form and show the TYP', function() {
    ...
    browser.switchTo().window(handles[1]).then(function(){
      ...
      //another Driver
      element(by.css('.addBtn yellow btntype2')).click();//issue
      element(by.id('driverfname_d2')).sendKeys('Jonh');
      element(by.id('driverlname_d2')).sendKeys('Rambo');
      element(by.id('dob_d2')).sendKeys('12111988');//issue
      element(by.id('gender_d2')).$('[value="M"]').click();
